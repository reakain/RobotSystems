...
if("TRUE" STREQUAL "TRUE")
  set(lab_config_SOURCE_PREFIX /home/ubuntu/armpi_fpv/src/lab_config)
  set(lab_config_DEVEL_PREFIX /home/ubuntu/armpi_fpv/devel)
  ...
  set(lab_config_INSTALL_PREFIX /home/ubuntu/armpi_fpv/install)
...
if(NOT "/home/ubuntu/armpi_fpv/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/armpi_fpv/src/lab_config/${idir}'.  ${_report}")
    endif()
