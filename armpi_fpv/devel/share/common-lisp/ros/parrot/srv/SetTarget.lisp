...
(cl:defmethod cl:initialize-instance :after ((m <SetTarget-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTarget-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parrot-srv:<SetTarget-request> is deprecated: use parrot-srv:SetTarget-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parrot-srv:data-val is deprecated.  Use parrot-srv:data instead.")
  (data m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetTarget-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTarget-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parrot-srv:<SetTarget-response> is deprecated: use parrot-srv:SetTarget-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parrot-srv:success-val is deprecated.  Use parrot-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SetTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parrot-srv:message-val is deprecated.  Use parrot-srv:message instead.")
  (message m))
