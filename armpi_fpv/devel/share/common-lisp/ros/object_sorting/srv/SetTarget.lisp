...
(cl:in-package object_sorting-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetTarget-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTarget-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_sorting-srv:<SetTarget-request> is deprecated: use object_sorting-srv:SetTarget-request instead.")))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <SetTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_sorting-srv:color-val is deprecated.  Use object_sorting-srv:color instead.")
  (color m))

(cl:ensure-generic-function 'tag-val :lambda-list '(m))
(cl:defmethod tag-val ((m <SetTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_sorting-srv:tag-val is deprecated.  Use object_sorting-srv:tag instead.")
  (tag m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetTarget-request>)))
  ...
  "object_sorting/SetTargetRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetTarget-request)))
  "Returns string type for a service object of type 'SetTarget-request"
  "object_sorting/SetTargetRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetTarget-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTarget-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_sorting-srv:<SetTarget-response> is deprecated: use object_sorting-srv:SetTarget-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_sorting-srv:success-val is deprecated.  Use object_sorting-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SetTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_sorting-srv:message-val is deprecated.  Use object_sorting-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetTarget-response>)))
  ...
  "object_sorting/SetTargetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetTarget-response)))
  "Returns string type for a service object of type 'SetTarget-response"
  "object_sorting/SetTargetResponse")
