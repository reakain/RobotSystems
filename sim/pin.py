...
class Pin(object):
    OUT = 0 #GPIO.OUT
    IN = 0 #GPIO.IN
    IRQ_FALLING = 0 #GPIO.FALLING
    IRQ_RISING = 0 #GPIO.RISING
    IRQ_RISING_FALLING = 0 #GPIO.BOTH
    PULL_UP = 0 #GPIO.PUD_UP
    PULL_DOWN = 0 #GPIO.PUD_DOWN
    PULL_NONE = None
